...
Excel은 Microsoft에서 제공하는 데이터 처리 및 분석 도구입니다. Excel을 사용하면 학교 업무 과정에서 또는 수업에서 얻은 데이터를 쉽고 효율적으로 관리할 수 있으며, 클라우드 기반으로 언제 어디서나 작업을 할 수 있습니다. 또한 텍스트, 숫자, 차트, 피벗 테이블 등을 활용하여 데이터를 시각화하고 분석하여 결과를 도출하는데 도움을 줍니다.

Excel을 활용하면 학교에서 사용하는 여러가지 자료를 csv, pdf, xlsx 등 다양한 포멧으로 변환하거나 공유할 수 있습니다. 또한 시험 점수 분석, 학생 출석부 관리, 예산 계획 등 다양한 학교 업무에 활용도가 매우 높은 MS 플랫폼입니다.

## 1. Excel의 종류

Excel은 오프라인 작업과 기능 완전성이 뛰어난 MS 365 앱 버전, 영구 라이선스로 제공되지만 최신 기능 업데이트가 제한적인 Excel 2019, [https://office.com/](https:/office.com)에서 사용하는 웹상의 Excel 그리고 스마트폰 Excel 앱이 있습니다.


![image](/images/excel/excelonline1/image2.jpg)
...
### | Excel for Web(웹 버전 Excel)

웹 버전(Excel for Web)의 경우 다음과 같은 특징이 있습니다.

1) 접근성: Edge 등 여러 브라우저를 통해 언제 어디서나 데이터에 접근할 수 있습니다. 설치가 필요 없으므로 어떤 디바이스에서도 사용 가능합니다.

2) 실시간 협업: 여러 사용자가 동시에 데이터를 편집하고 분석할 수 있습니다. 동기화가 매우 빠르게 이루어집니다.

3) 자동 저장 및 공유: 작업 중인 Excel 파일은 OneDrive에 자동으로 저장되며, 저장된 파일은 쉽게 공유하거나 협업할 수 있습니다. 학교에서 가장 도움이 되는 부분이라고 할 수 있겠습니다.

4) 기능 제한: 기본적인 데이터 입력, 서식 지정, 간단한 수식과 차트 작성 등의 기능은 지원하지만, 고급 함수, 매크로, 복잡한 데이터 모델 등의 고급 기능은 일부 지원되지 않을 수 있습니다.

웹 버전은 Excel의 기본적인 기능만 지원하기에, 함수를 이용한 데이터 분석이나 셀 서식을 활용한 시각화보다는 협업을 위한 시트와 데이터를 수합하고 정리하는 용도로 학교에서 유용하게 사용할 수 있습니다.
...
### | Excel for Desktop(앱 버전 Excel)

앱 버전(Excel for Desktop)의 경우 다음과 같은 특징이 있습니다.

1) 기능 완전성: 모든 고급 기능을 지원합니다. 고급 수식, 매크로 작성, 피벗 테이블, 데이터 모델링, Power Query 등 복잡한 분석 도구를 사용할 수 있습니다. 완전한 엑셀을 다루기 위해서는 웹 버전 보다는 앱 버전을 활용해야 합니다.

2) 오프라인 작업: 인터넷 연결 없이도 데이터를 수정, 저장, 분석할 수 있어 유연성이 높습니다

3) 성능: 고사양 컴퓨터에서 더 빠르고 안정적으로 작동하며, 대용량 데이터 처리에 적합합니다.

앱 버전으로 작업한 Excel 파일도 OneDrive에 저장하여 협업 및 공유가 가능하며, 버전 기록 및 자동 저장 기능을 활용할 수 있습니다.
