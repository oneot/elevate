  ...
  while (offset < centralDirectoryEnd) {
    ...
    if (!isMacosxMetadataEntry(normalizedFileName)) {
      entries.push({
        ...
        centralExtra: source.slice(fileNameEnd, centralExtraEnd),
        localExtra: source.slice(localHeaderOffset + ZIP_LOCAL_HEADER_SIZE + localNameLength, dataStart),
        comment: source.slice(centralExtraEnd, commentEnd),
        compressedData: source.slice(dataStart, dataEnd),
        fileName,
