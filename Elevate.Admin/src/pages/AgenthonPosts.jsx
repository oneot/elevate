...
function AgenthonPosts() {
  ...
  }, [msalInstance, page, statusFilter])
  ...
  return (
    <div className="space-y-10 animate-fadeIn">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="text-3xl font-bold text-gradient">Agenthon</h2>
          <p className="text-sm text-neutral-500 mt-1">Agenthon 관련 게시글을 관리합니다.</p>
        </div>
        <button
          onClick={() => navigate('/posts/new?category=agenthon')}
      ...
      {loading ? (
        ...
        <Card colorScheme="slate" className="text-center py-12">
          <div className="space-y-2">
            <p className="text-lg font-semibold text-neutral-900">Agenthon 게시글이 없습니다.</p>
